rem
rem  DO NOT RUN using SYS or SYSTEM accounts
rem
rem  change the following connect string to the account that will be used for the lab exercises
rem

connect user0/user0@xe
